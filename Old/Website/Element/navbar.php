    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="user_home.php"
                class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none nav-auto">
            ...
            <div class="text-end">
                ...
                <div class="dropdown" style="display: inline;">
                    <a href="#" class="link-dark text-decoration-none text-white dropdown-toggle" id="dropdownUser1"
